 ...
 */
final class Version20260520071902 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE starship_part ALTER starship_id SET NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE starship_part ALTER starship_id DROP NOT NULL');
    }
}
